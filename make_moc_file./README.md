Shell script calc_moc.sc calculates the Meridional Overturning Circulation (MOC) and Heat Transport. It calls calculate_msf_cesm.f and also needs the following files: 
